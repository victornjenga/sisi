...
const Post = ({ name, message, email, timestamp,id, postImage }) => {
        ...
        <View style={[styles.postcard, styles.elevation]}>
          ...
          <View style={{ borderTop: "1px solid #f7f5f2" }}>
            ...
            >
              ...
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("Comment",{name:name,postImage:postImage,timestamp:timestamp,message:message,id:id});
                }}
              >
                {" "}
